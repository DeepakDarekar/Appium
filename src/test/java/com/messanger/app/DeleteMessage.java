...
public class DeleteMessage {
	...
	public void DeleteSMS() throws MalformedURLException {
		...
		driver.findElementById("com.google.android.apps.messaging:id/compose_message_text").sendKeys("Hello There How are you doing Today");
		driver.findElementById("com.google.android.apps.messaging:id/self_send_icon").click();
		
		//Deleting the Messages after adding the Message
